...
import Sequelize, { DataTypes, Model, type InferAttributes, type InferCreationAttributes } from "@sequelize/core";
...
export class BlogV1Post extends Model<InferAttributes<BlogV1Post>, InferCreationAttributes<BlogV1Post>> {
